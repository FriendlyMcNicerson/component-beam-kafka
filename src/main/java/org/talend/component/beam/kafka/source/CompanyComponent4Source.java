...
public class CompanyComponent4Source implements Serializable {
    ...
    public CompanyComponent4Source(@Option("configuration") final CompanyComponent4MapperConfiguration configuration,

...
@PartitionMapper(name = "KafkaInput", infinite = true)
@Documentation("TODO fill the documentation for this mapper")
public class KafkaInputMapper implements Serializable {
    private final KafkaInputMapperConfiguration configuration;
    private final Component_beam_kafkaService service;
    private final JsonBuilderFactory jsonBuilderFactory;

    public KafkaInputMapper(@Option("configuration") final KafkaInputMapperConfiguration configuration,
    ...
    @Split
    public List<KafkaInputMapper> split(@PartitionSize final long bundles) {
        ...
        // In this case bundles = 100 and we must try to return 10 KafkaInputMapper with 1/10 of the overall work each.
        //
    ...
    @Emitter
    public KafkaInputSource createWorker() {
        // here we create an actual worker,
        // you are free to rework the configuration etc but our default generated implementation
        // propagates the partition mapper entries.
        return new KafkaInputSource(configuration, service, jsonBuilderFactory);
    }
}
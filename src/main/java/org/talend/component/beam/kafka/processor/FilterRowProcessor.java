...
public class FilterRowProcessor implements Serializable {
    ...
    @ElementListener
    public void onNext(
            @Input final FilterRowDefaultInput defaultInput,
            @Output final OutputEmitter<FilterRowDefaultOutput> defaultOutput,
            @Output("reject") final OutputEmitter<FilterRowRejectOutput> rejectOutput) {

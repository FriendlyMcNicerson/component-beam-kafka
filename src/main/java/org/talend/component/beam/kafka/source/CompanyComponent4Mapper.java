...
@PartitionMapper(name = "CompanyComponent4")
@Documentation("TODO fill the documentation for this mapper")
public class CompanyComponent4Mapper implements Serializable {
    private final CompanyComponent4MapperConfiguration configuration;
    private final Component_beam_kafkaService service;
    private final JsonBuilderFactory jsonBuilderFactory;

    public CompanyComponent4Mapper(@Option("configuration") final CompanyComponent4MapperConfiguration configuration,
    ...
    @Split
    public List<CompanyComponent4Mapper> split(@PartitionSize final long bundles) {
        ...
        // In this case bundles = 100 and we must try to return 10 CompanyComponent4Mapper with 1/10 of the overall work each.
        //
    ...
    @Emitter
    public CompanyComponent4Source createWorker() {
        // here we create an actual worker,
        // you are free to rework the configuration etc but our default generated implementation
        // propagates the partition mapper entries.
        return new CompanyComponent4Source(configuration, service, jsonBuilderFactory);
    }
}
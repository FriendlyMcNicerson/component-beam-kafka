...
public class CompanyComponent3Source implements Serializable {
    ...
    public CompanyComponent3Source(@Option("configuration") final CompanyComponent3MapperConfiguration configuration,

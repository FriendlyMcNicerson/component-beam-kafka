...
public class CompanyComponent3MapperBeamTest implements Serializable {
    @ClassRule
    ...
    public void produce() {
        ...
        final CompanyComponent3MapperConfiguration configuration =  new CompanyComponent3MapperConfiguration();

        // We create the component mapper instance using the configuration filled above
        final Mapper mapper = COMPONENT_FACTORY.createMapper(CompanyComponent3Mapper.class, configuration);

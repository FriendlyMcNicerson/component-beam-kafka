...
public class KafkaInputMapperBeamTest implements Serializable {
    @ClassRule
    ...
    public void produce() {
        ...
        final KafkaInputMapperConfiguration configuration =  new KafkaInputMapperConfiguration()
                /*  .setBrokers()
                  .setOffset() */;

        // We create the component mapper instance using the configuration filled above
        final Mapper mapper = COMPONENT_FACTORY.createMapper(KafkaInputMapper.class, configuration);
